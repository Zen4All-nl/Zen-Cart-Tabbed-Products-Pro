...
$menu_items_tpp = array(
  array('TPP_VERSION', '2.00', 1001, false),
...
zen_register_admin_page('configTPP', 'BOX_CONFIGURATION_TPP', 'FILENAME_CONFIGURATION', 'gID=' . $tpp_configuration_id, 'configuration', 'Y', $sort);
